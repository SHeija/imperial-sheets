...
void main() {
  group('SkillEditDialog', (){
    testWidgets('renders correcly w/ canHasMultiple=false', (WidgetTester tester) async {
    ...
    testWidgets('renders correctly w/ canHasMultiple=true', (WidgetTester tester) async {
      final Skill skill = Skill.notKnown(Constants.linguistics, Constants.linguistics)
