...
class WeightTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool isEncumbered = character.getItemWeight() > character.getCarryLimit();
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: isEncumbered ? Text('Encumbered', style: Theme.of(context).textTheme.bodyText2.copyWith(color: Theme.of(context).errorColor)) : Container(),
              ),
              Table(
